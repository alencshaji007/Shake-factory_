...
export function buildHero(stage, { covers, texts }) {
  ...
  tl.set(cast.map((l) => l.m), { opacity: 0 }, 4.95)
    ...
    .fromTo(drops.m, { opacity: 0, scale: 0.4 }, { opacity: 1, scale: 1.4, y: -vh(8), duration: 1, ease: 'expo.out' }, 5.52)
    .fromTo(splashWide.m, { opacity: 0, scale: 0.3 }, { opacity: 0.95, scale: 2.4, y: -vh(10), duration: 0.9, ease: 'power2.in' }, 5.75)
